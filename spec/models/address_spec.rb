...
describe 'Address model' do
  before do
    @address = Address.new(short_address: 'shortAddr1',
                           full_address: 'longAddr1', zipcode: 123_45,
                           country: 'country1')

    @address_short = Address.new(short_address: 'shortAddr1',
                                 full_address: 'longAddr2', zipcode: 123_46,
                                 country: 'country1')
  end
